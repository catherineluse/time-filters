import {
  ...
  export const getEventLengthFromISOs = (startTimeISO, endTimeISO) => {
    let humanReadableEndTime = getReadableTimeFromISO(endTimeISO);
    let lengthOfEvent = durationHoursAndMinutes(startTimeISO, endTimeISO);
